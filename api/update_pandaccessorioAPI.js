export default async function handler(req, res) {
  ...
  try {
    ...
    // ==========================================
    // STEP 1: GESTIONE IMMAGINE (Scarica, Carica Nuova, Cancella Vecchia)
    // ==========================================
    ...
    async function processJsFile(filePath, arrayName, action) {
        ...
        const bodyData = { message: `Aggiornato DB Pandaccessori via API Edit`, content: Buffer.from(decoded).toString("base64") };
